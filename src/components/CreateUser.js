...
const CreateUser = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      message.error(
        `Foydalanuvchi yaratishda xato: ${error.data?.message || error.message}`
      );
    }
  };
      ...
      <div style={{ width: "40%" }}>
        ...
        <Form layout="vertical" onFinish={onFinish}>
          ...
          <Form.Item
            ...
            name="name"
            rules={[
              { required: true, message: "Ism/Familiya kiritilishi shart" },
            ]}
          >
            <Input placeholder="Ism/Familiya  ingizni kiriting" />
          </Form.Item>
          <Form.Item>
